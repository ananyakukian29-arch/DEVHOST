...
def render_results_table(results: list) -> dict | None:
    ...
    df["badge"] = df["score"].apply(score_to_badge)
...
def _render_chart(df: pd.DataFrame) -> None:
    fig = px.bar(
        ...
        labels={"score": "Risk score", "display_path": "File"},
